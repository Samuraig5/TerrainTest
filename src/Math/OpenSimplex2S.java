...
public class OpenSimplex2S {
    ...
    /**
     * 2D Math.OpenSimplex2S/SuperSimplex noise, standard lattice orientation.
     */
    ...
    /**
     * 2D Math.OpenSimplex2S/SuperSimplex noise, with Y pointing down the main diagonal.
    ...
    /**
     * 2D  Math.OpenSimplex2S/SuperSimplex noise base.
     */
    ...
    /**
     * 3D Math.OpenSimplex2S/SuperSimplex noise, with better visual isotropy in (X, Y).
    ...
    /**
     * 3D Math.OpenSimplex2S/SuperSimplex noise, with better visual isotropy in (X, Z).
     * Recommended for 3D terrain and time-varied animations.
    ...
    /**
     * 3D Math.OpenSimplex2S/SuperSimplex noise, fallback rotation option
